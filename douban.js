...
const BOCAI_SITES = [
    { key: 'iqiyizyapi.com', name: '奇艺资源', api: 'https://iqiyizyapi.com/api.php/provide/vod' },
    { key: 'wolongzyw.com', name: '卧龙资源', api: 'https://wolongzyw.com/api.php/provide/vod' },
    { key: 'ffzyapi.com', name: '非凡资源', api: 'https://api.ffzyapi.com/api.php/provide/vod' },
    { key: 'dyttzyapi.com', name: '电影天堂', api: 'http://caiji.dyttzyapi.com/api.php/provide/vod' },
    { key: 'www.maoyanzy.com', name: '猫眼资源', api: 'https://api.maoyanapi.top/api.php/provide/vod' },
    { key: '360zy.com', name: '360资源', api: 'https://360zyzz.com/api.php/provide/vod' }
];
